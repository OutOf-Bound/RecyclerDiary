...
class OnboardFragment : Fragment() {
    ...
    private fun prepareText(): SpannableStringBuilder{
        ...
        val text_body: SpannableString = SpannableString("The very first thing users see when downloading an app these days is an onboarding screen.\n" +
        ...
        val text_ref: SpannableString = SpannableString("Also, Let’s connect on\n\n Twitter,  Linkedin,\n Github,  Facebook")

        sb.append(text_title)
        sb.setSpan(ForegroundColorSpan(resources.getColor(R.color.color6)),0,1,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        sb.setSpan(ForegroundColorSpan(resources.getColor(R.color.color2)),1,2,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        sb.setSpan(ForegroundColorSpan(resources.getColor(R.color.color3)),2,3,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        sb.setSpan(ForegroundColorSpan(resources.getColor(R.color.color5)),3,4,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        sb.setSpan(ForegroundColorSpan(resources.getColor(R.color.color4)),4,5,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        sb.setSpan(ForegroundColorSpan(resources.getColor(R.color.color1)),5,6,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        sb.setSpan(ForegroundColorSpan(resources.getColor(R.color.color0)),6,7,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        ...
        text_body.setSpan(StyleSpan(ITALIC),407,text_body.length,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_body.setSpan(ForegroundColorSpan(resources.getColor(R.color.color0)),0,3,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_body.setSpan(RelativeSizeSpan(1.5f),0,3,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_body.setSpan(BackgroundColorSpan(resources.getColor(R.color.color2)),55,82,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        ...
        text_body.setSpan(ForegroundColorSpan(resources.getColor(R.color.color1)),407,text_body.length,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_body.setSpan(BackgroundColorSpan(resources.getColor(R.color.color6)),500,555,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_body.setSpan(RelativeSizeSpan(1.1f),0,text_body.length,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        sb.append(text_body)
        text_ref.setSpan(RelativeSizeSpan(1.3f),0,22,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_ref.setSpan(ForegroundColorSpan(resources.getColor(R.color.white)),0,22,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_ref.setSpan(BackgroundColorSpan(resources.getColor(R.color.black)),0,22,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        text_ref.setSpan(RelativeSizeSpan(1.1f),0,text_ref.length,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        ...
        text_ref.setSpan(ForegroundColorSpan(resources.getColor(R.color.color5)),34,44,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
